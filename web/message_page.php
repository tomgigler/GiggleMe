...
elseif($message->special_handling & 16) print "    <th id='special_handling_header'>Set Topic</th>\n";
elseif($message->special_handling & 32) print "    <th id='special_handling_header'>Set Channel Name</th>\n";
else print "    <th id='special_handling_header'>Pin</th>\n";
print "    <td id='display_special_handling_cell' class='display_element'>";
if($message->special_handling & 1 || $message->special_handling & 8 || $message->special_handling & 16 || $message->special_handling & 32) print "True";
else print "False";
print "</td>\n";
print "    <td id='edit_special_handling_cell' class='edit_element'>\n";
print "      <input id='pin_message_checkbox' type='checkbox' ";
if($message->special_handling & 1 || $message->special_handling & 8) print "checked ";
print "/>\n";
print "    </td>\n";
print "  </tr>\n";
